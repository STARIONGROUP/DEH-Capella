 ...
 */
public interface ICapellaObjectBrowserViewModel extends IObjectBrowserBaseViewModel<ElementRowViewModel<? extends Element>>
{
    /**
     ...
     */
    void OnSelectionChanged(ElementRowViewModel<? extends Element> selectedRow);
